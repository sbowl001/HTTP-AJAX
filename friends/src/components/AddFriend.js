...
export default connect(null, { addFriend, updateFriend, deleteFriend })(
  AddFriend
);

//[Component] - dispatches -> [Action] - send to -> [Reducers] - update -> {store} - forces re-render on -> [Component]

/*
    -write the actions
    -write the action creators  => signature for the function(num, array) {return {type: '', payload}}
    - write the reducers (implementation of the action) how to do this?
    -write the component. DO I need to react to changes on the sotre? am I dispatching actions?
    ...
    function (selectedFriend, action) {
        //state.selectedFriend = actionpayload;
    }
